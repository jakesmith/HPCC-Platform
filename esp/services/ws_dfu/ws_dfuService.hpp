...
public:
    ...
    bool onDFUGetMetaInquiry(IEspContext &context, IEspDFUMetaInquiryRequest &req, IEspDFUMetaInquiryResponse &resp);
    ...
    virtual bool onDFSFileRename(IEspContext &context, IEspDFSFileRenameRequest &req, IEspDFSFileRenameResponse &resp);
