                                       ...
                                       const char* ClusterName)
{
    try
    {
        ...
        if (strcmp(eqTHORMACHINES,ClusterType) == 0)
        {
            ...
            getMachineList(ClusterName, eqThorSlaveProcess,path.str(),"", ClusterDirectory, MachineList);
            unsigned count = MachineList.length();
            getMachineList(ClusterName, eqThorSpareProcess,path.str(),"", ClusterDirectory, MachineList);
                                ...
                                IArrayOf<IEspTpMachine> &MachineList)
{
    try
    {
        ...
        ForEach(gi)
        {
            ...
            {
                machineInfo.setName("(external node)");
            }
