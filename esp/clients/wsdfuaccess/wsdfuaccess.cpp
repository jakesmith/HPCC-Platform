...
public:
    ...
    virtual bool lookup(StringBuffer &metaInfo, CDfsLogicalFileName &lfn, IUserDescriptor *user, bool write) const override
    {
        ...
        try
        {
            ...
            return getFileAccess(metaInfo, fileAccessUrl, wuidValue.str(), lfn.get(), access, expirySecs, userName, nullptr);
        }
        catch (IException *e)
        {
            StringBuffer eMsg;
