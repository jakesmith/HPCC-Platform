...
void initializeRoTable()
{
    ...
    // also populate read-only value table with unsigned 0-10000, many of which are very common
    unsigned maxConstUnsigned=10000;
    StringBuffer constStr;
    for (unsigned c=0; c<maxConstUnsigned; c++)
    {
