...
extern da_decl bool initClientProcess(IGroup *servergrp, DaliClientRole role, const SocketEndpoint &mpEp, const char *clientVersion=NULL, const char *minServerVersion=NULL, unsigned timeout=MP_WAIT_FOREVER);
