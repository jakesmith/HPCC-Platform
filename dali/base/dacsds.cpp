...
class MonitoredChildMap : public ChildMapC
{
    CClientRemoteTree &owner;
public:
    MonitoredChildMap(CClientRemoteTree &_owner) : ChildMapC(), owner(_owner) { }
    ...
    virtual bool replace(const char *name, IPropertyTree *tree)
    {
        ...
        bool res = ChildMapC::replace(name, tree);
