...
static void validateStore(bool fix, bool deleteFiles, bool removeStaleLocations, bool verbose)
{
    ...
    if (fix)
    {
        ...
        PROGLOG("Removed %d unassociated file entries. Took %u ms", numDeleted, ts.elapsed());
        ...
        PROGLOG("%d unassociated file entries to remove. Took %u ms - use 'fix=true'", numDeleted, ts.elapsed());
