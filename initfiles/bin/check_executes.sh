...
if [ -f ${runningFilename} ] || [ -f ${stoppedFilename} ]; then
  echo "${runningFilename} and/or ${stoppedFilename} already exists. It suggest previous this container restarted quickly (postrun sidecar hasn't spotted and cleared up yet)"
  secs=30
