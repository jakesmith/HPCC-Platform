...
IThorResult *CSlaveGraph::getGlobalResult(CActivityBase &activity, IRowInterfaces *rowIf, activity_id ownerId, unsigned id)
{
    ...
    msg.append(queryJobChannel().queryMyRank());
    msg.append(graphId);
    msg.append(ownerId);
    msg.append(id);
    msg.append(replyTag);
...
{
    jobChannels.append(*new CJobSlaveChannel(*this, mpServer));
}
...
// IGraphCallback
CJobSlaveChannel::CJobSlaveChannel(CJobBase &_job, IMPServer *mpServer) : CJobChannel(_job, mpServer)
{
