...
public:
    ...
    CRuntimeStatisticCollection &queryStats() { return activityCodeContext.queryStats(); }
    void doconnect();
...
public:
    ...
    CRuntimeStatisticCollection &queryStats() { return container.queryStats(); }
...
extern graph_decl unsigned jcsFunc1Ctx(ICodeContext *ctx, unsigned p1);
