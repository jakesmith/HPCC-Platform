...
class CThorMasterGraphResults : public CThorGraphResults
{
    ...
    public:
        ...
        CCollatedResult(CMasterGraph &_graph, ILWActivity &_activity, IRowInterfaces *_rowIf, unsigned _id, activity_id _ownerId, unsigned _spillPriority)
    ...
    // IThorResult
        ...
        virtual ILWActivity *queryActivity()
        {
            return &activity;
        }
...
public:
    CThorMasterGraphResults(unsigned numResults) : CThorGraphResults(numResults)
    {
    }
    virtual IThorResult *createResult(ILWActivity &activity, unsigned id, IRowInterfaces *rowIf, bool distributed, unsigned spillPriority)
    {
        Owned<CCollatedResult> result = new CCollatedResult((CMasterGraph &)activity.queryGraph(), activity, rowIf, id, ownerId, spillPriority);
        setResult(id, result);
        return result;
    }
};
...
IThorGraphResults *CJobMaster::createThorGraphResults(unsigned num)
{
    return new CThorMasterGraphResults(num);
}
