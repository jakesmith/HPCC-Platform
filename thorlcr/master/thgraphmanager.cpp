...
static std::vector<ConnectedWorkerDetail> connectedWorkers;
void publishPodNames(IWorkUnit *workunit, const char *graphName, std::vector<ConnectedWorkerDetail> *_connectedWorkers)
{
