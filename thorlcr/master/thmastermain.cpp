...
public:
    ...
    bool connect(unsigned slaves)
    {
        ...
        if (isContainerized())
        {
            ...
            const char *scopeName = globals->queryProp("@scopeName");
            Owned<IWorkUnitFactory> factory = getWorkUnitFactory();
            Owned<IConstWorkUnit> wuRead = factory->openWorkUnit(wuid);
            ...
            workunit->setStatistic(queryStatisticsComponentType(), queryStatisticsComponentName(), scopeType, scopeName, StWhenK8sReady, nullptr, timeStamp, 1, 0, StatsMergeReplace);
        }
...
int main( int argc, const char *argv[]  )
{
    ...
    try
    {
        ...
        if (isContainerized())
        {
            ...
            scopeName = globals->queryProp("@scopeName");
    ...
    try
    {
        ...
        if (isContainerized())
        {
            ...
            else
            {
                ...
                StatisticScopeType scopeType = getScopeType(scopeName);
                unsigned __int64 timeStamp = getTimeStampNowValue();
                workunit->setStatistic(queryStatisticsComponentType(), queryStatisticsComponentName(), scopeType, scopeName, StWhenK8sStarted, nullptr, timeStamp, 1, 0, StatsMergeReplace);
            }
