...
// IThorRowCollectorCommon
    ...
    virtual void setRowManager(roxiemem::IRowManager *_rowManager)
    {
...
// IThorRowCollectorCommon
    ...
    virtual void setRowManager(roxiemem::IRowManager *rowManager)
    {
        CThorRowCollectorBase::setRowManager(rowManager);
    }
