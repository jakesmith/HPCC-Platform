    ...
    virtual void process()
    {
        ...
        if (global)
        {
            ...
            loop
            {
                ...
                ownedResults.setown(queryJob().createThorGraphResults(3)); // will not be cleared until next sync
...
public:
    ...
    virtual void init()
    {
        ...
        Owned<IThorGraphResults> results = container.queryJob().createThorGraphResults(1);
    ...
    virtual void process()
    {
        ...
        Owned<IThorGraphResults> loopResults = container.queryJob().createThorGraphResults(maxIterations);
