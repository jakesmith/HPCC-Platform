...
protected:
    ...
    IThorRowCollector *handleFailoverToLocalRHS(ICompare *cmp)
    {
        ...
        try
        {
            ...
            Owned<IRowStream> distChannelStream = rhsDistributor->connect(queryRowInterfaces(rightITDL), right, rightHash, NULL, NULL);
        ...
        try
        {
            ...
            if (isGlobal())
            {
                ...
                else
                {
                    ...
                    left.setown(lhsDistributor->connect(queryRowInterfaces(leftITDL), left, leftHash, NULL, NULL));
