...
// NB: Non-reentrant implementation
...
public:
    ...
    inline void lock()
    {
        ...
        {
            /* Don't have CAS:
             * 1) Get CRIT - expect to block (CAS owner probably has CRIT too)
             * 2) When I can enter CRIT, expect to get CAS, but another lock() may get in.
             *    If get CAS - done, break out.
             *    if don't get CAS, leave crit, yield and loop to 1)
             */
            loop
            {
